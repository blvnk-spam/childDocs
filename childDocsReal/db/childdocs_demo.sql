...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 07, 2022 at 08:24 PM
...
(1, 'rogl', 'the', 'gamer', '2022-12-01', 1, 12, 2, '1'),
(2, 'a', 'b', 'c', '2022-11-04', 0, 12, 2, NULL);
...
INSERT INTO `weeklyplans` (`WeeklyPlanNum`, `WeekNum`, `Activities`, `PlanAuthor`, `PlanAuthorID`, `RoomNum`) VALUES
(1, '1', '3456\r\n456', '2', 2, 2),
(2, '2', 'all the planned weekly activities go here', 'ben', 3, 1);
...
--
-- AUTO_INCREMENT for table `weeklyplans`
--
ALTER TABLE `weeklyplans`
  MODIFY `WeeklyPlanNum` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `child`
  ADD CONSTRAINT `BusNum` FOREIGN KEY (`BusNum`) REFERENCES `busses` (`BusID`),
  ADD CONSTRAINT `GuardianSSN` FOREIGN KEY (`GuardianSSN`) REFERENCES `guardians` (`GuardianSSN`),
  ADD CONSTRAINT `Room` FOREIGN KEY (`RoomNum`) REFERENCES `rooms` (`RoomNum`);
